...
/**
 * Smarty date_format modifier plugin (enhanced with some new abilities)
 * 
 * Type:     modifier<br>
 * Name:     date_format<br>
 ...
 */
function smarty_modifier_date_format2($string, $format=null, $default_date='', $formatter='auto')
{
    if ($format === null) {
    ...
    */
    ...
    if ($format == '%relative') {
    	...
    	$format = "$weakDay, %d $monthName %Y %H:%M:%S GMT";
    }
