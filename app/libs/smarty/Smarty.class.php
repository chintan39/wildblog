...
class Smarty
{
    ...
    /**
     * sending header info with mime type
     * @var string
     */
    var $mime_type = 'text/html';
    
    /**
     * content type - coding (HTTP header)
     */
    var $coding = 'UTF-8';
 ...
 */
    ...
    {
   		header("Content-Type: {$this->mime_type}; charset={$this->coding}");
    ...
    function _parse_resource_name(&$params)
    {
        ...
        if ($params['resource_type'] == 'file') {
            if (!preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $params['resource_name'])) {
                ...
                /* absolute path */
                $params['resource_name'] = getcwd() . $params['resource_name'];
