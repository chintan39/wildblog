...
function __dlg_onclose() {
	if(opener.MediaDialog._return)
		opener.MediaDialog._return(null);
};
...
function __dlg_init(bottom) {
	...
	if(opener && opener.MediaDialog && opener.MediaDialog._arguments)
		window.mediaDialogArguments = opener.MediaDialog._arguments;
	if (!document.all) {
...
function __dlg_close(val) {
	opener.MediaDialog._return(val);
	window.close();
};
