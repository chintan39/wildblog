...
class LinkBuildingPartnersRoutes extends AbstractNodesRoutes {
	...
	public function setRouter() {
		...
		Router::registerSubaction($this, 'subactionPartnersMenu') 
			->setTemplate('part.partnerLinks');

		Router::registerAction($this, 'actionPartners')
			->addRuleUrl('partners/$')
